...
void show_time(byte left, byte right, byte c)
{
  write_char(0,(byte)((left/10)%10)+16,c);
  write_char(1,(byte)(left%10)+16,c);
  write_char(2,(byte)((right/10)%10)+16,c);
  write_char(3,(byte)(right%10)+16,c);
}
...
void loop()
{
  ...
  show_time(minute,second,3);
  delay(1000);
  show_time(minute,second,0);
